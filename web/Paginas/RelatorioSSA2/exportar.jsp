...
request.setAttribute("TITULO","Exportar Relatório SSA2");
...
function exportarRelatorio() {
	...
	if(callConfirm('Deseja exportar esse registro para o siab?')) {
		setParameters(document.relatorioSSA2Form,'exportar','');
	 ...
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
		  <tr>
            ...
            <td colspan="2"><html:text property="nascvivo" maxlength="6" readonly="true" /></td>
          </tr>
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;RN pesados ao nascer:</div></td>
            <td colspan="2"><html:text property="pesados" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RN com peso < 2500g:</div></td>
            <td colspan="2"><html:text property="peso2500" maxlength="6" readonly="true"/></td>
          </tr>
        </table>
	 </fieldset>
	  <br />
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
		  <tr>
            ...
            <td colspan="2"><html:text property="c_4meses" readonly="true"/></td>
          </tr>
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Aleitamento Exclusivo:</div></td>
            <td colspan="2"><html:text property="c_mamand" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Aleitamento Misto:</div></td>
            <td colspan="2"><html:text property="c_misto" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">De 0 a 11 meses e 29 dias:</div></td>
            <td colspan="2"><html:text property="c_0a11" maxlength="6" readonly="true"/></td>
          </tr>
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Com vacinas em dia:</div></td>
            <td colspan="2"><html:text property="c_vacdia" maxlength="6" readonly="true" /></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Pesadas:</div></td>
            <td colspan="2"><html:text property="c_0a112p" maxlength="6" readonly="true" /></td>
          </tr>
		   <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Desnutridas:</div></td>
            <td colspan="2"><html:text property="c_0a11gp" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">De 12 a 23 meses e 29 dias:</div></td>
            <td colspan="2"><html:text property="c_1223" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Com vacinas em dia:</div></td>
            <td colspan="2"><html:text property="c_vacina" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Pesadas:</div></td>
            <td colspan="2"><html:text property="c_12232p" maxlength="6" readonly="true" /></td>
          </tr>
		   <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Desnutridas:</div></td>
            <td colspan="2"><html:text property="c_1223gp" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
		   ...
		   <tr>
            ...
            <td colspan="2"><html:text property="c_diarre" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tiveram diarréia e usaram TRO:</div></td>
            <td colspan="2"><html:text property="c_diasro" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Que tiveram IRA:</div></td>
            <td colspan="2"><html:text property="c_ira" maxlength="6" readonly="true"/></td>
          </tr>
        </table>
	 </fieldset>
	   <br />
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
		  <tr>
            ...
            <td colspan="2"><html:text property="ngesCad" maxlength="6" readonly="true"/></td>
          </tr>
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Acompanhadas:</div></td>
            <td colspan="2"><html:text property="ngesac" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Com vacina em dia:</div></td>
            <td colspan="2"><html:text property="ngesvac" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Consulta de pre-natal no mês:</div></td>
            <td colspan="2"><html:text property="ngespre1" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pre-natal iniciado 1º trimestre:</div></td>
            <td colspan="2"><html:text property="ngespre2" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Menores de 20 anos cadastradas:</div></td>
            <td colspan="2"><html:text property="ngesm20" maxlength="6" readonly="true"/></td>
          </tr>
        </table>
	 </fieldset>
	   <br />
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
          ...
          <tr>
            ...
            <td colspan="2"><html:text property="d_diabete" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Acompanhados:</div></td>
            <td colspan="2"><html:text property="d_diaac" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Cadastrados:</div></td>
            <td colspan="2"><html:text property="d_hiperten" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Acompanhados:</div></td>
            <td colspan="2"><html:text property="d_hiperac" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Cadastrados:</div></td>
            <td colspan="2"><html:text property="d_tubercul" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Acompanhados:</div></td>
            <td colspan="2"><html:text property="d_tuberac" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Cadastrados:</div></td>
            <td colspan="2"><html:text property="d_hansen" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Acompanhados:</div></td>
            <td colspan="2"><html:text property="d_hanseac" maxlength="6" readonly="true"/></td>
          </tr>
        </table>
	 </fieldset>
	  <br />
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
		  <tr>
            ...
            <td colspan="2"><html:text property="h_0a5pneu" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">Menores de 5 anos por desidratação:</div></td>
            <td colspan="2"><html:text property="h_0a5des" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">Por abuso de alcool:</div></td>
            <td colspan="2"><html:text property="h_alcool" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">Por complicações do diabetes:</div></td>
            <td colspan="2"><html:text property="h_diabete" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td><div align="left">Por outras causas:</div></td>
            <td colspan="2"><html:text property="h_outcau" maxlength="6" readonly="true"/></td>
          </tr>
		   <tr>
            <td>&nbsp;</td>
            <td colspan="2">&nbsp;</td>
		   ...
		   <tr>
            ...
            <td colspan="2"><html:text property="h_psiqui" maxlength="6" readonly="true"/></td>
          </tr>
        </table>
	 </fieldset>
	  <br />
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
          ...
          <tr>
            ...
            <td colspan="2"><html:text property="o_dia0a28" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;IRA:</div></td>
            <td colspan="2"><html:text property="o_ira0a28" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Outras causas:</div></td>
            <td colspan="2"><html:text property="o_cau0a28" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Diarreia:</div></td>
            <td colspan="2"><html:text property="o_dia28a1" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;IRA:</div></td>
            <td colspan="2"><html:text property="o_ira28a1" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Outras causas:</div></td>
            <td colspan="2"><html:text property="o_cau28a1" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
          ...
          <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Diarreia:</div></td>
            <td colspan="2"><html:text property="obitodia" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;IRA:</div></td>
            <td colspan="2"><html:text property="obitoira" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td><div align="left">&nbsp;&nbsp;&nbsp;Outras causas:</div></td>
            <td colspan="2"><html:text property="obitocau" maxlength="6" readonly="true"/></td>
          </tr>
		  <tr>
            <td>&nbsp;</td>
            <td colspan="2">&nbsp;</td>
		   ...
		   <tr>
            ...
            <td colspan="2"><html:text property="o_mul10a14" maxlength="6" readonly="true"/></td>
		  </tr>
		  <tr>
            <td><div align="left">Mulheres de 15 a 49:</div></td>
            <td colspan="2"><html:text property="obitomul" maxlength="6" readonly="true"/></td>
		  </tr>
		  <tr>
            <td><div align="left">Outros Obitos:</div></td>
            <td colspan="2"><html:text property="obitoout" maxlength="6" readonly="true"/></td>
		  </tr>
		  <tr>
            <td><div align="left">10 a 19 anos por violência:</div></td>
            <td colspan="2"><html:text property="obitoadol" maxlength="6" readonly="true"/></td>
		  </tr>
        </table>
	 </fieldset>
	 <br />
	 <fieldset style="width:80%">
		...
		<table width="100%" border="0">
		  <tr>
            ...
            <td colspan="2"><html:text property="nfamicad" maxlength="6" readonly="true"/></td>
          </tr>
           <tr>
            <td><div align="left">Número de Visitas:</div></td>
            <td colspan="2"><html:text property="nvisitas" maxlength="6" readonly="true"/></td>
          </tr>
        </table>
	 </fieldset>
	 <table width="100%" cellspacing="0" cellpadding="5">
	  <tr>
		...
		<logic:equal name="relatorioSSA2Form" property="exportado" value="N">
		      <input name="btnExportar" type="button" class="button" onClick="javascript:exportarRelatorio()" value="Exportar"> 
	    </logic:equal>
